      ...
      <div className="bottombannersecondconbb">
        <div className="bottombannersecondonebb">
          ...
          <p className="secondpara">
            Reduce your expenses by applying to grants, bursaries and
            scholarships.
          </p>
        </div>
        <div className="bottombannersecondtwobb">
          ...
          <p className="secondparatwo">
            Here's a low down on the major documents your'll need to make an
            application
          </p>
        </div>
        <div className="bottombannersecondthreebb">
          ...
          <p className="secondpara">
            We have mapped a timeline for you to get started with your study
            abroad journey
          </p>
        </div>
        <div className="bottombannersecondfourbb">
          {" "}
          <img className="bottombannersecondimg" src={TimeHigher}></img>
