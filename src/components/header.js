...
const Header = () => {
      return (
        <div className='header'>
            ...
            <ul className='headerul'>
              <li className='lione'><a href="/" alt="logoddd"><img className='headerlogosd' src={IIEC_logo}></img></a></li>
              <li className='litwo'><input id="searchimputplaceholdersd" className='header_placeholdersd' placeholder='Search' ></input></li>
              <li className='lithree eventsd'><span><img className='eventvectorsssd' src={EventIcons}></img></span>Event</li>
              <li className='lifour findussd'><span><img className='locationvectorsd' src={Locationvector}></img></span>Find us</li>
              <li className='lifive'><button className='enquirebtnsd' >Enquire</button></li>
