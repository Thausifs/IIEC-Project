    ...
    return (
       ...
       <div className="dropdown">
         ...
         <div className="dropdown-contentsecond">
           ...
           <a href="/studentvisaapplication">Student visa application assistance </a>
           <a href="/predeparturesupport">Pre-departure support</a>
           <a href="/Aboutiiec">About us</a>
         </div>
       </div>
       <div className="dropdown">
         <button className="dropbtn">Study Destination
       ...
       <div className="dropdown">
         <button className="dropbtn">Other Services
       ...
       <div className="dropdown">
         <button className="dropbtn">Training    
         </button>
