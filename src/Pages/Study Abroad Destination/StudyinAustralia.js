...
import "../../Asserts/Css/Pages/studyinaustralia.css";
...
const StudyinAustralia = ()=>{
    return (
         <div className='studyinaustraliapage'>
             <Header></Header>
             <Navbar></Navbar>
           <div className='studyinaustraliastd'>  <StudyAbroad></StudyAbroad></div> 
            <h1 className='studyinaustraliamainhead'>Study in Australia</h1>
           ...
           <div>
            ...
            <h2 className='studyinaustraliaheadings'>School boarding houses</h2>
            <p className='studyinaustraliaparas'>Most primary and high school international students live in boarding houses on the school grounds. You’re likely to share a room with other students. Bathroom, dining and recreation areas are shared. You’re provided with three meals a day. Students are supervised at all times. Boarding fees range from $10,000 to $20,000 a year.</p>
            <h2 className='studyinaustraliaheadings'>Homestay with a local family</h2>
          <p className='studyinaustraliaparas'>Homestay means living with an Australian family and immersing yourself in the Australian way of life. Homestay can be either a “room only” arrangement or “full board” where the host family provides meals. For many parents of international students, homestay means security as their children are living at home with responsible adults. Homestay is often arranged through the education institution to ensure that students are placed with an appropriate family. This is often a good option for younger students including high school students and English language students. Homestay fees are from around $110 to $270 a week.</p>
          <h2 className='studyinaustraliaheadings'>Rented apartments and houses</h2>
          <p className='studyinaustraliaparas'>In Australia, students often share an apartment or house with others. There are usually two to four students in a share house. You have your own bedroom but share living areas, kitchen and laundry. Rent, electricity, gas and telephone costs are shared. You can live alone if you prefer. This is also a great option for students with families. Universities often have an accommodation office to help with finding a rental home. Rental costs depend on the area, city or regional location and style of house or apartment. For a single person in a shared house, costs are from $70 to $250 a week. To rent out an entire apartment or house can cost from $100 to $600 depending on the size and location.</p>
          <h2 className='studyinaustraliaheadings'>EDUCATION SYSTEM</h2>
          <p className='studyinaustraliaparas'>The Australian education system is broadly divided into the university, vocational, school and English language sectors.</p>
          <p className='studyinaustraliaparas'>University is the highest level of study in Australia. There are 41 universities in total – 38 public (government funded) and three private. You can study at the undergraduate level (Bachelor degree) or postgraduate level (Graduate Certificate, Diploma, Masters, PhD).</p>
          <p className='studyinaustraliaparas'>Vocational institutions are closely linked with industry, making courses very practical and skill-based. Vocational courses are provided at both the government-funded Technical and Further Education (TAFE) institutes and at private institutions. Some universities also offer vocational courses.</p>
          <p className='studyinaustraliaparas'>School is compulsory for children aged between 6 and 15 years, with exams for university generally at 18 years old. Australian schools are public (government) and private (religious or independent).</p>
          <p className='studyinaustraliaparas'>English language courses can be taken for study, travel, immigration or business purposes. There are around 100 private English language centres in Australia. Some universities and vocational institutes also offer English language courses</p>
          <h2 className='studyinaustraliaheadings'>Entry requirements</h2>
          <p className='studyinaustraliaparas'>Australian institutions have two sets of entry requirements: academic and English language skills. If you do not meet the requirements, you may be able to do a bridging or linking course.</p>
          <p className='studyinaustraliaparas'>Academic entry requirements</p>
...
<h2 className='studyinaustraliaheadings'>Getting to your institution from your home country</h2>
<p className='studyinaustraliaparas'>Australia’s capital cities all have airports and most of these have international terminals. Many other cities and large towns also have airports. You’ll fly into a major city and then, dependent on the location of your institution, fly to another town or catch a bus or train</p>
<p className='studyinaustraliaparas'>Some institutions will arrange to meet you at the airport. At the beginning of each year, IDP sets up a meeting point at Sydney and Melbourne airports to help you. We also have an airport pick-up service that you can book for Sydney, Melbourne, Brisbane and Perth</p>
<p className='studyinaustraliaparas'>Australia is a large country with an extensive transport network. Be aware that there are long distances between cities and towns. Planes, buses and trains link between cities and regional areas. Cars are popular, particularly in country areas. If you want to drive, make sure you have an international driver’s permit, usually available through your country’s motoring association.</p>
<h2 className='studyinaustraliaheadings'>Getting around
</h2>
<p className='studyinaustraliaparas'>Cities have public transport networks supported by buses, trains, trams and ferries. You can buy weekly tickets which give you a discount. Student concessions are available to international students in all states except NSW and Victoria.
</p>
<p className='studyinaustraliaparas'>Buses are the cheapest option between cities, followed by trains and the planes. Recent competition in the airline industry has meant cheaper plane prices – particularly when tickets are bought online.</p>
<h2 className='studyinaustraliaheadings'>VOCATIONAL EDUCATION & TRAINING</h2>
<p className='studyinaustraliaparas'>
Australia’s vocational education and training programs are known for their practical skills and job-ready approach.</p>
<p className='studyinaustraliaparas'>You can do a vocational course to begin a career, as a pathway to university or to gain practical skills to advance your career.</p>
<p className='studyinaustraliaparas'>Courses have a practical focus and many provide work placements. They are designed together with professional and industry bodies to meet the current needs of the global marketplace.
</p>
<p className='studyinaustraliaparas'>Vocational institutions offer over a thousand courses in every industry from engineering to computer programming, cookery to hotel management, legal studies to business management.
</p>
