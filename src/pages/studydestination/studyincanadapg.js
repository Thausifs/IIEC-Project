  ...
  return(
   <div className="page">
    ...
    <div className='dis_flex'>
        ...
        <p className='mainhead'>Study in Canada</p>
           <p className='pagebold'>WHY CANADA ?</p>
           <p className='pagepara'>Canada is waiting for you!  Canadians are generally very welcoming and respectful of cultural differences. Canadian educational institutions encourage new students from abroad and many universities have targets to increase their numbers of international students. When you go looking for a study abroad destination within Canada, you have a multitude of options available to you.

</p>
        <p className='pagepara'> Live in a cosmopolitan city and get your education in a country of diversity like no other.
...
<p className='pagepara'>Canada offers a wide choice of 90 universities and 150 colleges and technical institutes, offering a wide range of programs. You will find excellent professors, reputable scientists and world-renowned artists and writers a part of the faculty at Canadian universities. Canada is a world leader in software development, telecommunications, aerospace engineering, urban transport, biotechnology, mining technology and environmental industries.
</p>
...
<p className='pagebold'>LIVING IN CANADA</p>
<p className='pagebold'>Climate:</p>
<p className='pagepara'>There are many climates in Canada and they vary from the permanently frozen ice caps north of the 70th parallel to the lush vegetation of British Columbia’s west coast. Overall, however, Canada has four very distinct seasons, particularly in the more populated regions along the US border. Daytime summer temperatures can rise to 35°C and higher, while lows of -15°C are not uncommon in winter. More moderate temperatures are the norm in spring and fall. Over the years, Canadians have adapted extremely well to the colder periods of weather by installing heating in houses and cars, and by having heated public transportation systems
</p>
