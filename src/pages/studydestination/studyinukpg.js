  ...
  return(
   <div className="page">
    ...
    <div className='dis_flex'>
        ...
        <p className='mainhead'>Study in UK</p>
          <p className='pagebold'>WHY LONDON ?</p>  
    <p className='pagepara'>The UK is a gateway to Europe! Though a small continent, Europe is diverse and fascinating.
...
<p className='pagebold'>STUDYING IN THE UK IS A SMART CHOIC</p>
<p className='pagebold'>World Class Qualification
</p>
...
The international alumni from UK institutions includes many leading politicians, thinkers and business people who have had an important influence on the world such as Bill Clinton (former President of the USA), Wole Soyinka (Nobel prize-winning author) and Imran Khan (cricket legend and politician).
    ...
    <li className=''>The sheer variety of specializations means finding a course that suits your real interests, your ambitions and passions.
</li>

</ul>
<p className='pagebold'>Modern Learning Environment
</p>
<ul className='pagepara'>
    <li className=''>Employers want employees who can think effectively, creatively and independently.
</li>
    <li className='' >UK institutions use a variety of teaching and assessment methods to encourage independence, as well as mastery of the subject.
</li>
    <li className='' >Students are expected to use the information they are given to stimulate their original thinking.</li>
</ul>
<p className='pagebold'>Quality of Education
</p>
<ul className='pagepara'>
    <li className='' >The education system provides facilities such as international student’s societies, planned social activities, academic support, and academic counselors. UK has one of the lowest ‘drops out rates.
</li>
    <li className=''>Its quality is unrivaled throughout the world.
</li>
    <li className=''>Encourages relevant skills that are marketable and sought by today’s top companies.</li>

</ul>
<p className='pagebold'>Affordable
</p>
<ul className='pagepara'>
    <li className=''>Realization of earning potentials sooner.
</li>
    <li className=''>Numerous Scholarships and bursaries offered by UK institutions.
</li>
    <li className=''>Almost free health care by National Health Service.
</li>
    <li className=''>Student discount facilities provided free through National </li>
    <li className=''>Union of Students membership for all students.
</li>
</ul>
<p className='pagebold'>Choice</p>
<p className='pagepara'>Vast choice of institutions, academics and subjects.
    Flexible programs.
...
<ul className='pagepara'>
    <li className=''>Cosmopolitan place to live.
</li>
    <li className=''>Home to numerous ethnic groups and nationalities from around the world.
</li>
    <li className=''>Tolerant, stable society where students learn about diverse range of people.
</li>
</ul>
<p className='pagebold'>Duration
</p>
<ul className='pagepara'>
...
<p className='pagebold'>MBA IN UK</p>
<p className='pagepara'>With a strong practical and professional orientation to the curriculum, the main emphasis of the programme is on leadership through strategic management. Its objectives are fourfold:</p>
<ul className='pagepara'>
    <li className=''>The advanced study of organizations, their management and the changing global context in which they operate.
</li>
    <li className=''>Preparation for and/or development of a career in business and management by developing skills at a professional or equivalent level, or as preparation for research or further study in the area.
</li>
    <li className=''>Development of the ability to apply knowledge and understanding of business and management to complex issues, both systematically and creatively, to improve business and management practice.
</li>
    <li className=''>Enhancement of lifelong learning skills and personal development so as to be able to work with self-direction and originality and to contribute to business and society at large.
</li>
</ul>

<p className='pagepara'>This is a generalist programme designed to add value to a first degree and to further the career development of individuals who have significant post-graduation and relevant work experience – which means at least two years and typically much more.
</p>
<p className='pagepara'>Throughout your MBA studies, you will be encouraged to ground your new knowledge within the base of your professional experience; to reflect on and learn from your prior experience; to integrate new knowledge with past experience and to apply it to new situations. You will also be encouraged to challenge preconceptions and remove subject and functional boundaries so as to handle complex situations holistically.</p>
<p className='pagepara'>As you study, you will develop particular strengths in data collection, critical reflective data analysis, creative thinking, and formulating, synthesizing and solving complex unstructured business problems through an evaluative evidence / assumption development based approach. In addition to communicating your findings you will develop the skills to implement agreed solutions effectively and efficiently at both an individual and team level. You will also develop your interpersonal skills to be able to interact effectively with a range of specialists.</p>
<p className='pagepara'>Upon successful completion of the MBA programme you will have developed a broad knowledge and understanding of organizations, the external context in which they operate and how they are managed. You will be able to understand, respond to and lead change, demonstrating intellectual breadth by making integrative links across the various areas of organizations. You will have fine-tuned your personal effectiveness in terms of self-awareness, self-reflection and self-management; time management; sensitivity to diversity in people and different situations and the ability to continue to learn through reflection on practice and experience.
</p>
<p className='pagepara'>In short, you will be ideally equipped to develop your career in a management role within your chosen company. And should you plan to launch your own business, you will have the skills and understanding to implement your entrepreneurial ideas.</p>


<p className='pagebold'>LIVING IN UK</p>
<p className='pagepara'>All our accommodation is carefully selected, visited and monitored by Hosts International to ensure that standards are maintained and to make sure your stay is a comfortable one. Hostels and residences are very popular too, mainly because of their low cost and central location but they can get full very quickly, particularly during the summer. We do advise you to book as early as possible in order to have the best choice. It may be possible to find accommodation for you at short notice, but it is advisable to inform us of your requirements at least four weeks before your date of arrival.
</p>
<p className='pagepara'>
...
Eng (Bachelor of Engineering) – an engineering degree
    ...
    <li className=''>Undergraduate Masters degree (e.g. M. Eng) – an enhanced four year undergraduate degree including extra subjects studied at a deeper level</li>
</ul>
    

<p className='pagebold'>Applying for postgraduate study
</p>
<p className='pagepara'>You will usually require at least a 2:1 (approximately 3.0 GPA) but entry requirements will depend on the course you apply for and where you previously studied. Most British masters courses are one year (12 months) in duration
Postgraduate includes.</p>
<p className='pagepara'>Students who receive good grades in their undergraduate degrees may choose to take a Masters degree, which takes a minimum of one year to complete. Types of Mastersdegree include:</p>
<ul className='pagepara'>
...
<p className='pagepara' >Some courses have additional entry requirements such as previous work experience, submission of written work with the application or previous study of a particular subject. Departments sometimes have different entry requirements so it is important to check the individual course information before you apply:
</p>
<ul  className='pagepara'>
    <li className=''>If you do not have the appropriate subject background for direct entry to first year, or you have not studied the appropriate subjects to the required depth, (which may be the case if you have followed a 12-year education system), you might be eligible to undertake a foundation year course to bring you up to the right level for first year entry.
</li>
    <li className=''>
