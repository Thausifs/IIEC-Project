   ...
   <div className="page">
    ...
    <div className='dis_flex'>
        ...
        <h1 className='mainhead'>EB5 VISA </h1>
                <h2 className='pagebold'>EB-5 Investor Visa Program applies to Investing in the U.S.A.</h2>
                ...
                <ul className='pagebold'>
                  <p className='pagebold'>BENEFITS TO IMMIGRANTS :</p>
                    ...
                    <li className='pagepara'>Recognition of dual citizenship
</li>
                    <li className='pagepara'>Live and work in any skill
</li>
                    <li className='pagepara'>Citizenship benefits to permanent residents
</li>
                    <li className='pagepara'>Medical, education and social benefits
</li>
                    <li className='pagepara'>Basic health care free
</li>
                    <li className='pagepara'>Education up to Secondary level free
</li>
                    <li className='pagepara'>Very small tuition fee for Post Secondary Education
</li>
                    <li className='pagepara'>Unemployment allowance after certain period.    </li>
                    </ul>
